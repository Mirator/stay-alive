...
public static class StayAlivePrototypeBuilder
{
    ...
    [MenuItem("Stay Alive/Build Proof of Concept")]
    public static void BuildProofOfConcept()
    {
        BuildPrototype();
    }

    public static void BuildPrototypeFromCommandLine()
    {
        BuildPrototype();
    }
    ...
    private static void BuildPrototype()
    {
        ...
        Debug.Log("Stay Alive proof of concept scene generated.");
    }
    ...
    private static void CreateScene(Dictionary<string, Sprite> sprites, GameObject torchPrefab)
    {
        ...
        GameObject root = new GameObject("Stay Alive Proof of Concept");
