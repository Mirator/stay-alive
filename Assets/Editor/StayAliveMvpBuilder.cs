...
public static class StayAliveMvpBuilder
{
    ...
    [MenuItem("Stay Alive/Build Wilderness MVP")]
    public static void BuildMvp()
    {
        Build();
    }

    public static void BuildMvpFromCommandLine()
    {
        Build();
    }
    ...
    private static void Build()
    {
        ...
        Debug.Log("Stay Alive wilderness MVP scene generated.");
    }
    ...
    private static Dictionary<string, Sprite> GenerateSprites()
    {
        ...
        sprites["grass"] = SaveSprite("mvp_grass_tile", CreateGrassTile(), SpritePpu, false);
        sprites["soil"] = SaveSprite("mvp_soil_tile", CreateSoilTile(), SpritePpu, false);
        sprites["water"] = SaveSprite("mvp_water_tile", CreateWaterTile(), SpritePpu, false);
        sprites["tree"] = SaveSprite("mvp_tree", CreateTree(), SpritePpu, true);
        sprites["log"] = SaveSprite("mvp_log_node", CreateLogNode(), SpritePpu, true);
        sprites["stone"] = SaveSprite("mvp_stone_node", CreateStoneNode(), SpritePpu, true);
        sprites["food"] = SaveSprite("mvp_food_bush", CreateFoodBush(), SpritePpu, true);
        sprites["herb"] = SaveSprite("mvp_herb_plant", CreateHerbPlant(), SpritePpu, true);
        sprites["floor"] = SaveSprite("mvp_build_floor", CreateBuildFloor(), SpritePpu, true);
        sprites["wall"] = SaveSprite("mvp_build_wall", CreateBuildWall(), SpritePpu, true);
        sprites["door"] = SaveSprite("mvp_build_door", CreateBuildDoor(), SpritePpu, true);
        sprites["campfire"] = SaveSprite("mvp_campfire", CreateCampfire(), SpritePpu, true);
        sprites["bedroll"] = SaveSprite("mvp_bedroll", CreateBedroll(), SpritePpu, true);
        sprites["storage"] = SaveSprite("mvp_storage_box", CreateStorageBox(), SpritePpu, true);
        sprites["workbench"] = SaveSprite("mvp_workbench", CreateWorkbench(), SpritePpu, true);
        sprites["wolf"] = SaveSprite("mvp_wolf", CreateWildAnimal(new Color(0.23f, 0.25f, 0.24f, 1f), new Color(0.85f, 0.36f, 0.12f, 1f)), SpritePpu, true);
        sprites["boar"] = SaveSprite("mvp_boar", CreateWildAnimal(new Color(0.38f, 0.24f, 0.16f, 1f), new Color(0.95f, 0.8f, 0.55f, 1f)), SpritePpu, true);

        sprites["playerIdleDown"] = SaveSprite("mvp_player_idle_down", CreatePlayerSprite(Facing.Down, 0, false), SpritePpu, true);
        sprites["playerIdleUp"] = SaveSprite("mvp_player_idle_up", CreatePlayerSprite(Facing.Up, 0, false), SpritePpu, true);
        sprites["playerIdleSide"] = SaveSprite("mvp_player_idle_side", CreatePlayerSprite(Facing.Side, 0, false), SpritePpu, true);
        sprites["playerWalkDownA"] = SaveSprite("mvp_player_walk_down_a", CreatePlayerSprite(Facing.Down, 1, false), SpritePpu, true);
        sprites["playerWalkDownB"] = SaveSprite("mvp_player_walk_down_b", CreatePlayerSprite(Facing.Down, 2, false), SpritePpu, true);
        sprites["playerWalkUpA"] = SaveSprite("mvp_player_walk_up_a", CreatePlayerSprite(Facing.Up, 1, false), SpritePpu, true);
        sprites["playerWalkUpB"] = SaveSprite("mvp_player_walk_up_b", CreatePlayerSprite(Facing.Up, 2, false), SpritePpu, true);
        sprites["playerWalkSideA"] = SaveSprite("mvp_player_walk_side_a", CreatePlayerSprite(Facing.Side, 1, false), SpritePpu, true);
        sprites["playerWalkSideB"] = SaveSprite("mvp_player_walk_side_b", CreatePlayerSprite(Facing.Side, 2, false), SpritePpu, true);
        sprites["playerMineDown"] = SaveSprite("mvp_player_attack_down", CreatePlayerSprite(Facing.Down, 0, true), SpritePpu, true);
        sprites["playerMineUp"] = SaveSprite("mvp_player_attack_up", CreatePlayerSprite(Facing.Up, 0, true), SpritePpu, true);
        sprites["playerMineSide"] = SaveSprite("mvp_player_attack_side", CreatePlayerSprite(Facing.Side, 0, true), SpritePpu, true);
        return sprites;
    }
    ...
    private static void CreateScene(Dictionary<string, Sprite> sprites)
    {
        ...
        GameObject root = new GameObject("Stay Alive Wilderness MVP");
        ...
        CreateMainMenu(root.transform, saves);
        CreateCamera(player.transform);
        CreateUi(player, cycle);
        CreateEventSystem();
    ...
    private static void CreateMainMenu(Transform parent, SurvivalSaveSystem saves)
    {
    ...
    private static void CreateUi(GameObject player, DayNightCycle cycle)
    {
        GameObject canvasObject = new GameObject("MVP UI");
        ...
        Text stone = CreateUiText("Stone Counter", canvasObject.transform, font, "Stone: 0", new Vector2(18f, -18f), new Vector2(280f, 26f), 20, TextAnchor.UpperLeft, new Color(0.9f, 0.86f, 0.75f));
        Text wood = CreateUiText("Wood Counter", canvasObject.transform, font, "Wood: 0", new Vector2(18f, -44f), new Vector2(280f, 26f), 20, TextAnchor.UpperLeft, new Color(0.8f, 0.95f, 0.68f));
        Text foodHerbs = CreateUiText("Food Herbs Counter", canvasObject.transform, font, "Food: 0 | Herbs: 0", new Vector2(18f, -70f), new Vector2(360f, 26f), 20, TextAnchor.UpperLeft, new Color(0.95f, 0.82f, 0.65f));
        Text crafted = CreateUiText("Crafted Counter", canvasObject.transform, font, "Spear: 0 | Bandage: 0 | Campfire: 0 | Bedroll: 0", new Vector2(18f, -96f), new Vector2(620f, 26f), 19, TextAnchor.UpperLeft, new Color(1f, 0.76f, 0.45f));
        Text vitals = CreateUiText("Vitals", canvasObject.transform, font, "Health: 100 | Hunger: 100", new Vector2(18f, -122f), new Vector2(420f, 26f), 20, TextAnchor.UpperLeft, new Color(1f, 0.72f, 0.7f));
        ...
        Text objective = CreateUiText("Objective", canvasObject.transform, font, "Survive in the wild.", new Vector2(0f, -50f), new Vector2(760f, 34f), 20, TextAnchor.UpperCenter, new Color(0.9f, 1f, 0.78f));
        ...
        GameObject deathPanel = CreateDeathPanel(canvasObject.transform, font);
    ...
    private static GameObject CreateDeathPanel(Transform parent, Font font)
    {
        ...
        Text label = CreateUiText("Death Text", panel.transform, font, "You died\nLoad Save or Return To Menu", Vector2.zero, new Vector2(390f, 130f), 24, TextAnchor.MiddleCenter, Color.white);
